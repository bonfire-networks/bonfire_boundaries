defmodule Bonfire.Boundaries.Web.MyAclsLive do
  ...
  def update(assigns, socket) do
    ...
    args = if e(assigns, :setting_boundaries, nil) do
      [current_user, Acls.opts_for_dropdown()]
    else
      if scope==:instance and ( Integration.is_admin?(current_user) || Bonfire.Boundaries.can?(current_user, :grant, :instance) ) do
        [Bonfire.Boundaries.Fixtures.admin_circle, [extra_ids_to_include: built_in_ids]]
      else
        [current_user]
      end
    end
